...
export async function POST() {
  ...
  // TODO: Fix sample data generation script schema mismatches
  return NextResponse.json(
    {
      error: "Sample data generation is temporarily disabled",
      message: "This feature needs to be updated to match the current schema",
    },
    { status: 501 }
  );
