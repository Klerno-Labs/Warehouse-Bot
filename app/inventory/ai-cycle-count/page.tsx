...
export default function AICycleCountPage() {
    ...
    mutationFn: async (itemIds: string[]) => {
      const response = await fetch("/api/cycle-counts", {
        ...
        body: JSON.stringify({
          ...
          description: `Generated by AI analyzer using ${countType} strategy`,
          itemIds,
          source: "AI_ANALYZER",
        }),
      });
  ...
  const createCycleCount = async () => {
    ...
    createCountMutation.mutate(Array.from(selectedItems));
  };
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    disabled={selectedItems.size === 0 || createCountMutation.isPending}
                  >
                    <Calendar className="mr-2 h-4 w-4" />
                    {createCountMutation.isPending ? "Creating..." : `Create Cycle Count (${selectedItems.size})`}
                  </Button>
                </div>
              </div>
            </CardHeader>
